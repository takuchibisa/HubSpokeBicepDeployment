...
resource ausHub 'Microsoft.OperationalInsights/workspaces@2021-06-01' = {
  name: 'aus-hub-${location}-${suffix}'
  location: location
  properties: {
    sku: {
      name: 'PerGB2018'
...
resource ausHub_diagnosticsSettings 'Microsoft.Insights/diagnosticSettings@2021-05-01-preview' = {
  name: 'to-hub-aus'
  scope: ausHub
  properties: {
    workspaceId: ausHub.id
    logs: [
      {
